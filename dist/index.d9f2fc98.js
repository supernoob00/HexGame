...
class $014f4e9ab2325c0b$export$76748c987176663a {
    ...
    drawGameInfo() {
        ...
        else if (this.controller instanceof (0, $f2bd93d1bc05a04b$export$862991097cec0aa4)) this.GAME_INFO.textContent = this.game.getCurrentPlayer() === (0, $cbc6d97b232e082b$export$50792b0e93539fde).RED ? "Red" : "Blue to move.";
        else if (this.controller instanceof (0, $cec8df7c1a458b34$export$dd37bcc5a24d523f)) {
            if (this.game.getCurrentPlayer() === this.controller.getAiToken()) this.GAME_INFO.textContent = "Thinking...";
            else this.GAME_INFO.textContent;
        }
    }
    /**
...
$0ccd03270594991d$var$newGameButton.onclick = $0ccd03270594991d$var$startTwoPlayerGame;
...
$0ccd03270594991d$var$newGameAIButton.onclick = $0ccd03270594991d$var$startAIGame;
// start game
$0ccd03270594991d$var$startTwoPlayerGame();


//# sourceMappingURL=index.d9f2fc98.js.map
